...
<body>
    ...
    <section class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                <img src="/build/img/anuncio1.webp" alt="anuncio1">
                <div class="contenido-anuncio">
                    <h3>Casa de Lujo en el Lago</h3>
                    <p>Casa en el lago con exelente vista y acabados de lujo a un exelente precio</p>
            ...
            <div class="anuncio">
                <img src="/build/img/anuncio2.webp" alt="anuncio2">
                <div class="contenido-anuncio">
            ...
            <div class="anuncio">
                <img src="/build/img/anuncio3.webp" alt="anuncio3">
                <div class="contenido-anuncio">
    ...
    <section class="imagen-contacto">
        ...
        <p>Llena el formulario y un asesor se pondrá en contacto contigo a la breveded</p>
    ...
    <div class="contenedor seccion seccion-inferior">
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>El personal se comportó de una exelente forma, muy buena atención y la casa que me ofrecieron cumple con todas mis expectativas.</blockquote>
                <p>-Joaquin Mouxaut</p>
            </div>
        </section>
    </div>
